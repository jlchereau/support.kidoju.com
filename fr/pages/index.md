...
<div class="row">
    <div class="col-sm-6 col-md-4">
        <div class="thumbnail k-widget">
            ...
            <div class="caption">
                <h3>Brochure</h3>
                <p style="min-height: 32px;">Un résumé des fonctionnalités et des bénéfices de la plateforme Kidoju.</p>
                <p>
    ...
    <div class="col-sm-6 col-md-4">
        <div class="thumbnail k-widget">
            ...
            <div class="caption">
                ...
                <p style="min-height: 32px;">Les instructions pas à pas pour concevoir et jouer des quiz phénoménaux sur la plateforme Kidoju.</p>
                <p>
    ...
    <div class="col-sm-6 col-md-4">
        <div class="thumbnail k-widget">
            ...
            <div class="caption">
                <h3>Blog</h3>
                <p style="min-height: 32px;">Pour s'informer au quotidien et découvrir des trucs et astuces.</p>
    ...
    <div class="col-sm-6 col-md-4">
        <div class="thumbnail k-widget">
            ...
            <div class="caption">
                ...
                <p style="min-height: 32px;">Pour ceux qui préfèrent voir et écouter que lire.</p>
    ...
    <div class="col-sm-6 col-md-4">
        <div class="thumbnail k-widget">
            ...
            <div class="caption">
                <h3>Suggestions</h3>
                <p style="min-height: 32px;">Pour nous faire parvenir vos souhaits et influencer l'avenir de la plateforme Kidoju.</p>
                <p>
    ...
    <div class="col-sm-6 col-md-4">
        <div class="thumbnail k-widget">
            ...
            <div class="caption">
                ...
                <p style="min-height: 32px;">Pour communiquer avec nous sur n'importe quel sujet.</p>
                <p>
