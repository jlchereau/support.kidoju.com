...
<div class="row">
    <div class="col-sm-6 col-md-4">
        <div class="thumbnail k-widget">
            ...
            <div class="caption">
                <h3>Datasheet</h3>
                <p style="min-height: 32px;">A summary of the features and benefits of the Kidoju platform.</p>
                <p>
    ...
    <div class="col-sm-6 col-md-4">
        <div class="thumbnail k-widget">
            ...
            <div class="caption">
                <h3>User Guide</h3>
                <p style="min-height: 32px;">Step by step instructions to design and play phenomenal quizzes on the Kidoju platform.</p>
                <p>
    ...
    <div class="col-sm-6 col-md-4">
        <div class="thumbnail k-widget">
            ...
            <div class="caption">
                <h3>Blog</h3>
                <p style="min-height: 32px;">To learn every day and discover tips and tricks.</p>
    ...
    <div class="col-sm-6 col-md-4">
        <div class="thumbnail k-widget">
            ...
            <div class="caption">
                ...
                <p style="min-height: 32px;">For those who prefer to watch and listen than read.</p>
    ...
    <div class="col-sm-6 col-md-4">
        <div class="thumbnail k-widget">
            ...
            <div class="caption">
                <h3>User Feedback</h3>
                <p style="min-height: 32px;">To send us your wishes and influence the future of the Kidoju platform.</p>
    ...
    <div class="col-sm-6 col-md-4">
        <div class="thumbnail k-widget">
            ...
            <div class="caption">
                ...
                <p style="min-height: 32px;">To contact us about any subject.</p>
                <p>
